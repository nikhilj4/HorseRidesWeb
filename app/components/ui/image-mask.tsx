...
const Component = React.forwardRef<HTMLDivElement, ComponentProps>(
    ({ className, ...props }, ref) => (
        <div ref={ref} className={className} {...props}>
            ...
            <section className='grid grid-cols-3 gap-8 border rounded-lg p-5'>
            ...
            <section className='mt-4 border rounded-lg p-5'>
                <figure className='relative group h-60 md:h-96 w-full'>
                    <svg
...
Component.displayName = 'ImageMaskGallery';
